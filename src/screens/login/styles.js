...
const styles = StyleSheet.create({
    ...
    PageStyle: { backgroundColor: "#eb6c49",paddingTop:80},
    LoginPage: { backgroundColor: "white", borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 5,height:700},
    ...
    IconStyle:{ width: 30, height: 30, margin: 20 },
  });
